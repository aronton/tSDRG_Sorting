...
# read -p "Oz, ZL or Both?(Oz,ZL,Both) : " orderparameter
# sinfo
# read -p "partition : " partition
# scontrol show partition scopion${partition}
# read -p "cpus-per-task : " cpuspertask
# read -p "Spin : " Spin
# read -p "ProbDis : " P
# read -p "BondDim : " bonDim
# read -p "Init_L : " L1
# read -p "Final_L : " L2
...
#         if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}" ]; then
#             # 目錄 /path/to/dir 存在
#             echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}"
#         else
#             # 目錄 /path/to/dir 不存在
#             echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}"
#             mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}"
#         fi

#         if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}" ]; then
#             # 目錄 /path/to/dir 存在
#             echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}"
#         else
#             # 目錄 /path/to/dir 不存在
#             echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}"
#             mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}"
#         fi
...
#                 if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}" ]; then
#                     # 目錄 /path/to/dir 存在
#                     echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}"
#                 else
#                     # 目錄 /path/to/dir 不存在
#                     echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}"
#                     mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}"
#                 fi

#                 if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}" ]; then
#                     # 目錄 /path/to/dir 存在
#                     echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}"
#                 else
#                     # 目錄 /path/to/dir 不存在
#                     echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}"
#                     mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}"
#                 fi
...
#                         if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}/D${D}" ]; then
#                             # 目錄 /path/to/dir 存在
#                             echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}/D${D}"
#                         else
#                             # 目錄 /path/to/dir 不存在
#                             echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}/D${D}"
#                             mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/record/L${L}/J${J}/D${D}"
#                         fi
                        
#                         if [ -d "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}/D${D}" ]; then
#                             # 目錄 /path/to/dir 存在
#                             echo "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}/D${D}"
#                         else
#                             # 目錄 /path/to/dir 不存在
#                             echo "mkdir /home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}/D${D}"
#                             mkdir "/home/aronton/tSDRG_project/Sorting_data/Spin15/slurm/L${L}/J${J}/D${D}"
#                         fi
    ...
    do
            ...
            do
                    ...
                    do
                            ...
                            # for (( k=${Nseed}; k>=0; k=k-${deltaSeed}))
                            # do
                            #         Nseed=${k}
                            #         path="/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv"
                            #         echo "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv"
                            #         echo -e "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv" >> "${file}.txt"
                            #         if [ -f "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv" ] ; then
                            #             s2=$k
                            #             echo "ok:${Nseed}"
                            #             echo -e "ok:${Nseed}" >> "${file}.txt"
                            #             break
                            #         fi
                            # done
                            ...
                            do
                                    seed=$k
                                    initial_path="/home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/metadata/SOP_Accumulation/${Jdis}/${Dim}/SOP_Accumulation_${Jdis}_${Dim}_finalSeed_${k}_PBC_L${L}_P${ProbDis}_m${bonDim}.csv"
                            ...
                            for (( k=${seed2}; k>=0; k=k-1000))
                            do
                                    seed=$k
                                    
                                    path="/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${ProbDis}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv"

                                    echo -e "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${ProbDis}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv\n"

                                    echo -e "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${ProbDis}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv\n" >> "${file}.txt"

                                    if [ -f "/home/aronton/tSDRG_project/tSDRG/Main_${Spin}/data/PBC/${Jdis}/${Dim}/L${L}_P${ProbDis}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}/L${L}_P${P}_m${bonDim}_${k}_string.csv" ] ; then
                                        s2=$seed
                            ...
                            sed -e "s@fileName@$replace1@" -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh
                            ...
                            sed -e 's/Spin/Spin'"$Spin"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh

                            sed -e 's/scopion/scopion'"$partition"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh
                            
                            sed -e 's/cpus-per-task/cpus-per-task='"$Ncore"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh 
                            
                            sbatch /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh ${L} ${L} 0 ${J} ${J} 0 ${D} ${D} 0 ${s1} ${s2} ${Nseed} ${Spin}

                            echo -e "sbatch /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/L${L}/${Jdis}/${Dim}/SOP_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh ${Spin} ${BC} ${ProbDis} ${bonDim} ${L} ${Jdis} ${Dim} ${s1} ${s2}\n" 
