...
def get_dx_frame(dx, spin, originalframe, L, J, D, seed):
    ...
    bulk_dx_seperate_dir_path = "/home/aronton/tSDRG_project/Sorting_data/Spin" + str(spin) + "/metadata/bulk_dx_seperate/" + str(J) + "/" + str(D) + "/" + "L" + str(L) + "/dx_" + str(dx) + "/"
...
def get_ave_frame(dx, spin, L, J, D, intial_seed, final_seed):
    ...
    bulk_dx_accumulate_dir_path = "/home/aronton/tSDRG_project/Sorting_data/Spin" + str(spin) + "/metadata/bulk_dx_accumulate/" + str(J) + "/" + str(D) + "/" + "L" + str(L) + "/dx_" + str(dx) + "/"
    ...
    ave_dir = "/home/aronton/tSDRG_project/Sorting_data/Spin" + str(spin) + "/metadata/bulk_ave/" + str(J) + "/" + str(D) + "/" + "L" + str(L) + "/dx_" + str(dx) + "/"

    if(os.path.exists(ave_dir) == False):
        os.makedirs(ave_dir) 

    # average csv path
    ave_csv = "/home/aronton/tSDRG_project/Sorting_data/Spin" + str(spin) + "/metadata/bulk_ave/" + str(J) + "/" + str(D) + "/" + "L" + str(L) + "/dx_" + str(dx) + "/" + "bulk_ave_L" + str(L) + "_" + str(J) + "_" + str(D) + "_dx_" + str(dx) + ".csv"
