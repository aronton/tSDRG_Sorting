...
do
        ...
        do
                ...
                do
                        ...
                        cp ./ZL/Zsub.sh /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh

                        echo -e "./ZL/Zsub.sh /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh\n" 

                        echo -e "./ZL/Zsub.sh /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh\n" >> "${file}.txt"

                        replace1=${orderparameter}"/B"${bonDim}"/"$Jdis"/"$Dim"/L"${L}"/ZL_spin"${Spin}"_L"$L"_"$Jdis"_"$Dim"_seed1="$s1"_seed2="$s2

                        sed -e "s@fileName@$replace1@" -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh

                        sed -e 's/Spin/Spin'"$Spin"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh

                        sed -e 's/scopion/scopion'"$partition"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh
                        
                        sed -e 's/cpus-per-task/cpus-per-task='"$Ncore"'/' -i /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh 

                        sbatch /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh ${Spin} ${BC} ${ProbDis} ${bonDim} ${L} ${Jdis} ${Dim} ${s1} ${s2} 

                        echo -e "sbatch /home/aronton/tSDRG_project/Sorting_data/Spin${Spin}/record/${orderparameter}/B${bonDim}/${Jdis}/${Dim}/L${L}/ZL_spin${Spin}_L${L}_${Jdis}_${Dim}_seed1=${s1}_seed2=${s2}.sh ${Spin} ${BC} ${ProbDis} ${bonDim} ${L} ${Jdis} ${Dim} ${s1} ${s2}\n" 
