...
nohup sh /home/aronton/tSDRG_project/Sorting_data/tSDRG_Sorting/rm_meta_empty/rm_meta_empty.sh $orderparameter $partition $Ncore $Spin $P $bonDim $L1 $L2 $space_L $J1 $J2 $space_J $D1 $D2 $space_D $BC $deltaSeed&
